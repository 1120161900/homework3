...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator objectAnimatorX= ObjectAnimator.ofFloat(target, "scaleX", 1.0f, 2.0f);
       ...
       // objectAnimatorX.start();
        ...
        ObjectAnimator objectAnimatorY = ObjectAnimator.ofFloat(target, "scaleY", 1.0f, 2.0f);
       ...
       // objectAnimatorY.start();
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(target,"alpha",1,0.5f,1);
      ...
      //  animator.start();
        ...
        animatorSet.playTogether(animator1,objectAnimatorX,objectAnimatorY,animator);
        animatorSet.start();
    }
}
